package com.helloappscrmfsm.features.logoutsync.presentation
...
import com.helloappscrmfsm.app.AppDatabase
import com.helloappscrmfsm.app.NetworkConstant
import com.helloappscrmfsm.app.Pref
import com.helloappscrmfsm.app.domain.*
import com.helloappscrmfsm.app.types.FragType
import com.helloappscrmfsm.app.utils.AppUtils
import com.helloappscrmfsm.app.utils.Toaster
import com.helloappscrmfsm.base.BaseResponse
import com.helloappscrmfsm.base.presentation.BaseActivity
import com.helloappscrmfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.helloappscrmfsm.features.billing.api.AddBillingRepoProvider
import com.helloappscrmfsm.features.billing.model.AddBillingInputParamsModel
...
import com.helloappscrmfsm.features.dashboard.presentation.ReasonDialog
...
import com.helloappscrmfsm.features.document.model.AddEditDocumentInputParams
import com.helloappscrmfsm.features.document.model.DocumentAttachmentModel
...
import com.helloappscrmfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.helloappscrmfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.helloappscrmfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.helloappscrmfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.helloappscrmfsm.features.orderhistory.model.*
...
import com.helloappscrmfsm.features.quotation.model.AddQuotInputModel
import com.helloappscrmfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.helloappscrmfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.helloappscrmfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.helloappscrmfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.helloappscrmfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
import com.helloappscrmfsm.features.stockCompetetorStock.ShopAddCompetetorStockRequest
...
import com.helloappscrmfsm.features.timesheet.model.AddTimeSheetInputModel
import com.helloappscrmfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.helloappscrmfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.helloappscrmfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.helloappscrmfsm.mappackage.SendBrod
import com.helloappscrmfsm.widgets.AppCustomTextView
import com.helloappscrmfsm.MonitorService
import com.helloappscrmfsm.MySingleton
import com.helloappscrmfsm.features.addshop.model.*
import com.helloappscrmfsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.helloappscrmfsm.features.addshop.presentation.ShopExtraContactReq
import com.helloappscrmfsm.features.addshop.presentation.multiContactRequestData
...
import com.helloappscrmfsm.features.login.model.GetConcurrentUserResponse
import com.helloappscrmfsm.features.login.model.WhatsappApiData
import com.helloappscrmfsm.features.performance.model.Gps_status_list
import com.helloappscrmfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.helloappscrmfsm.features.returnsOrder.ReturnProductList
import com.helloappscrmfsm.features.returnsOrder.ReturnRequest
import com.helloappscrmfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xhelloappscrmfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xhelloappscrmfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xhelloappscrmfsmlogsample/log.zip").path);
