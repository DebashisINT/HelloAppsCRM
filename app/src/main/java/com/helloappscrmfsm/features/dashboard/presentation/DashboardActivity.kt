package com.helloappscrmfsm.features.dashboard.presentation
...
import com.helloappscrmfsm.*
import com.helloappscrmfsm.R
import com.helloappscrmfsm.app.*
import com.helloappscrmfsm.app.NewFileUtils.browseDocuments
import com.helloappscrmfsm.app.NewFileUtils.browsePDFDocuments
import com.helloappscrmfsm.app.NewFileUtils.getExtension
import com.helloappscrmfsm.app.domain.*
import com.helloappscrmfsm.app.types.DashboardType
import com.helloappscrmfsm.app.types.FragType
import com.helloappscrmfsm.app.types.TopBarConfig
import com.helloappscrmfsm.app.uiaction.DisplayAlert
import com.helloappscrmfsm.app.utils.*
import com.helloappscrmfsm.app.utils.AppUtils.Companion.isProfile
import com.helloappscrmfsm.base.BaseResponse
import com.helloappscrmfsm.base.presentation.BaseActivity
import com.helloappscrmfsm.base.presentation.BaseFragment
import com.helloappscrmfsm.features.NewQuotation.*
import com.helloappscrmfsm.features.NewQuotation.api.GetQuotRegProvider
import com.helloappscrmfsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.helloappscrmfsm.features.SearchLocation.SearchLocationFragment
import com.helloappscrmfsm.features.SearchLocation.locationInfoModel
import com.helloappscrmfsm.features.TA.ViewAllTAListFragment
import com.helloappscrmfsm.features.achievement.AchievementFragment
import com.helloappscrmfsm.features.activities.presentation.*
import com.helloappscrmfsm.features.addAttendence.*
import com.helloappscrmfsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.helloappscrmfsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.helloappscrmfsm.features.addAttendence.model.GetReportToFCMResponse
import com.helloappscrmfsm.features.addAttendence.model.GetReportToResponse
import com.helloappscrmfsm.features.addAttendence.model.Leave_list_Response
import com.helloappscrmfsm.features.addorder.presentation.AddOrderFragment
import com.helloappscrmfsm.features.addshop.model.AddShopRequestData
import com.helloappscrmfsm.features.addshop.model.AddShopResponse
import com.helloappscrmfsm.features.addshop.presentation.AddShopFragment
import com.helloappscrmfsm.features.addshop.presentation.OTPVerificationDialog
import com.helloappscrmfsm.features.addshop.presentation.ScanImageFragment
import com.helloappscrmfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.helloappscrmfsm.features.alarm.model.AlarmData
import com.helloappscrmfsm.features.alarm.presetation.AttendanceReportFragment
import com.helloappscrmfsm.features.alarm.presetation.PerformanceReportFragment
import com.helloappscrmfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.helloappscrmfsm.features.alarm.presetation.VisitReportFragment
import com.helloappscrmfsm.features.attendance.AttendanceFragment
import com.helloappscrmfsm.features.attendance.api.AttendanceRepositoryProvider
import com.helloappscrmfsm.features.attendance.model.AttendanceRequest
import com.helloappscrmfsm.features.attendance.model.AttendanceResponse
import com.helloappscrmfsm.features.averageshop.presentation.AverageShopFragment
import com.helloappscrmfsm.features.avgorder.presentation.AverageOrderFragment
import com.helloappscrmfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.helloappscrmfsm.features.beatCustom.TeamBeatListFragment
import com.helloappscrmfsm.features.billing.presentation.AddBillingFragment
import com.helloappscrmfsm.features.billing.presentation.BillingDetailsFragment
import com.helloappscrmfsm.features.billing.presentation.BillingListFragment
import com.helloappscrmfsm.features.changepassword.presentation.ChangePasswordDialog
import com.helloappscrmfsm.features.chat.model.ChatListDataModel
import com.helloappscrmfsm.features.chat.model.ChatUserDataModel
import com.helloappscrmfsm.features.chat.model.GroupUserDataModel
import com.helloappscrmfsm.features.chat.presentation.*
import com.helloappscrmfsm.features.chatbot.presentation.ChatBotFragment
import com.helloappscrmfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.helloappscrmfsm.features.chatbot.presentation.ReportsFragment
import com.helloappscrmfsm.features.chatbot.presentation.SelectLanguageDialog
import com.helloappscrmfsm.features.commondialog.presentation.CommonDialog
import com.helloappscrmfsm.features.commondialog.presentation.CommonDialogClickListener
import com.helloappscrmfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.helloappscrmfsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.helloappscrmfsm.features.commondialogsinglebtn.OnDialogClickListener
import com.helloappscrmfsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.helloappscrmfsm.features.contacts.ContactDtls
import com.helloappscrmfsm.features.contacts.ContactGr
import com.helloappscrmfsm.features.contacts.ContactMasterRes
import com.helloappscrmfsm.features.contacts.ContactsAddFrag
import com.helloappscrmfsm.features.contacts.ContactsFrag
import com.helloappscrmfsm.features.contacts.SchedulerViewFrag
import com.helloappscrmfsm.features.contacts.SchedulerAddFormFrag
import com.helloappscrmfsm.features.contacts.TypeMasterRes
import com.helloappscrmfsm.features.dailyPlan.prsentation.AllShopListFragment
import com.helloappscrmfsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.helloappscrmfsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.helloappscrmfsm.features.damageProduct.ShopDamageProductListFrag
import com.helloappscrmfsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.helloappscrmfsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.helloappscrmfsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.helloappscrmfsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.helloappscrmfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.helloappscrmfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.helloappscrmfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.helloappscrmfsm.features.dashboard.presentation.model.ContentListResponseModel
import com.helloappscrmfsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.helloappscrmfsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.helloappscrmfsm.features.device_info.presentation.DeviceInfoListFragment
import com.helloappscrmfsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.helloappscrmfsm.features.document.DocumentRepoFeatureNewFragment
import com.helloappscrmfsm.features.document.presentation.DocumentListFragment
import com.helloappscrmfsm.features.document.presentation.DocumentTypeListFragment
import com.helloappscrmfsm.features.document.presentation.OpenFileWebViewFragment
import com.helloappscrmfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.helloappscrmfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.helloappscrmfsm.features.dymanicSection.presentation.DynamicListFragment
import com.helloappscrmfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.helloappscrmfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.helloappscrmfsm.features.home.presentation.HomeFragment
import com.helloappscrmfsm.features.homelocation.presentation.HomeLocationFragment
import com.helloappscrmfsm.features.homelocation.presentation.HomeLocationMapFragment
import com.helloappscrmfsm.features.know_your_state.KnowYourStateFragment
import com.helloappscrmfsm.features.lead.LeadFrag
import com.helloappscrmfsm.features.lead.ViewLeadFrag
import com.helloappscrmfsm.features.leaveapplynew.LeaveHome
import com.helloappscrmfsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.helloappscrmfsm.features.localshops.LocalShopListFragment
import com.helloappscrmfsm.features.localshops.LocalShopListMapFragment
import com.helloappscrmfsm.features.localshops.NearByShopsMapFragment
import com.helloappscrmfsm.features.location.*
import com.helloappscrmfsm.features.location.api.LocationRepoProvider
import com.helloappscrmfsm.features.location.model.*
import com.helloappscrmfsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.helloappscrmfsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.helloappscrmfsm.features.login.ShopFeedbackEntity
import com.helloappscrmfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.helloappscrmfsm.features.login.presentation.LoginActivity
import com.helloappscrmfsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.helloappscrmfsm.features.logoutsync.presentation.LogoutSyncFragment
import com.helloappscrmfsm.features.marketAssist.MarketAssistTabFrag
import com.helloappscrmfsm.features.marketAssist.ShopDtlsMarketAssistFrag
import com.helloappscrmfsm.features.marketAssist.ShopListMarketAssistFrag
import com.helloappscrmfsm.features.marketing.presentation.MarketingPagerFragment
import com.helloappscrmfsm.features.meetinglist.prsentation.MeetingListFragment
import com.helloappscrmfsm.features.member.MapViewForTeamFrag
import com.helloappscrmfsm.features.member.model.TeamLocDataModel
import com.helloappscrmfsm.features.member.model.TeamShopListDataModel
import com.helloappscrmfsm.features.member.presentation.*
import com.helloappscrmfsm.features.menuBeat.MenuBeatFrag
import com.helloappscrmfsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.helloappscrmfsm.features.micro_learning.presentation.MicroLearningListFragment
import com.helloappscrmfsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.helloappscrmfsm.features.myallowancerequest.MyallowanceRequestFragment
import com.helloappscrmfsm.features.myjobs.model.CustomerDataModel
import com.helloappscrmfsm.features.myjobs.presentation.*
import com.helloappscrmfsm.features.myorder.presentation.MyOrderListFragment
import com.helloappscrmfsm.features.myprofile.presentation.MyProfileFragment
import com.helloappscrmfsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.helloappscrmfsm.features.nearbyshops.model.ShopData
import com.helloappscrmfsm.features.nearbyshops.model.ShopListResponse
import com.helloappscrmfsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.helloappscrmfsm.features.nearbyshops.presentation.BeatListFragment
import com.helloappscrmfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.helloappscrmfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.helloappscrmfsm.features.nearbyshops.presentation.ShopCallHisFrag
import com.helloappscrmfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.helloappscrmfsm.features.newcollection.CollectionDetailsStatusFragment
import com.helloappscrmfsm.features.newcollection.CollectionShopListFragment
import com.helloappscrmfsm.features.newcollection.NewCollectionListFragment
import com.helloappscrmfsm.features.newcollectionreport.*
import com.helloappscrmfsm.features.notification.NotificationFragment
import com.helloappscrmfsm.features.orderList.NewDateWiseOrderListFragment
import com.helloappscrmfsm.features.orderList.NewOrderListFragment
import com.helloappscrmfsm.features.orderList.OrderListFragment
import com.helloappscrmfsm.features.orderdetail.presentation.OrderDetailFragment
import com.helloappscrmfsm.features.orderhistory.ActivityMapFragment
import com.helloappscrmfsm.features.orderhistory.OrderhistoryFragment
import com.helloappscrmfsm.features.orderhistory.TimeLineFragment
import com.helloappscrmfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.helloappscrmfsm.features.orderhistory.model.FetchLocationRequest
import com.helloappscrmfsm.features.orderhistory.model.FetchLocationResponse
import com.helloappscrmfsm.features.orderhistory.model.LocationData
import com.helloappscrmfsm.features.pendinglocationinout.PendingOutLocationFrag
import com.helloappscrmfsm.features.performance.GpsStatusFragment
import com.helloappscrmfsm.features.performance.PerformanceFragment
import com.helloappscrmfsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.helloappscrmfsm.features.performance.model.UpdateGpsInputParamsModel
import com.helloappscrmfsm.features.performanceAPP.OwnPerformanceFragment
import com.helloappscrmfsm.features.performanceAPP.PerformanceAppFragment
import com.helloappscrmfsm.features.performanceAPP.allPerformanceFrag
import com.helloappscrmfsm.features.permissionList.ViewPermissionFragment
import com.helloappscrmfsm.features.photoReg.*
import com.helloappscrmfsm.features.privacypolicy.PrivacypolicyWebviewFrag
import com.helloappscrmfsm.features.quotation.presentation.*
import com.helloappscrmfsm.features.reimbursement.presentation.*
import com.helloappscrmfsm.features.report.presentation.*
import com.helloappscrmfsm.features.returnsOrder.*
import com.helloappscrmfsm.features.settings.presentation.SettingsFragment
import com.helloappscrmfsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.helloappscrmfsm.features.shopdetail.presentation.*
import com.helloappscrmfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.helloappscrmfsm.features.stock.StockDetailsFragment
import com.helloappscrmfsm.features.stock.StockListFragment
import com.helloappscrmfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.helloappscrmfsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.helloappscrmfsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.helloappscrmfsm.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.helloappscrmfsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.helloappscrmfsm.features.stockCompetetorStock.CompetetorStockFragment
import com.helloappscrmfsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.helloappscrmfsm.features.survey.SurveyFrag
import com.helloappscrmfsm.features.survey.SurveyViewDtlsFrag
import com.helloappscrmfsm.features.survey.SurveyViewFrag
import com.helloappscrmfsm.features.task.presentation.AddTaskFragment
import com.helloappscrmfsm.features.task.presentation.CalenderTaskFragment
import com.helloappscrmfsm.features.task.presentation.EditTaskFragment
import com.helloappscrmfsm.features.task.presentation.TaskListFragment
import com.helloappscrmfsm.features.taskManagement.TaskManagementFrag
import com.helloappscrmfsm.features.taskManagement.ViewTaskManagementFrag
import com.helloappscrmfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.helloappscrmfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.helloappscrmfsm.features.timesheet.presentation.TimeSheetListFragment
import com.helloappscrmfsm.features.viewAllOrder.CartFragment
import com.helloappscrmfsm.features.viewAllOrder.OrderTypeListFragment
import com.helloappscrmfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.helloappscrmfsm.features.viewAllOrder.ViewCartFragment
import com.helloappscrmfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.helloappscrmfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.helloappscrmfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.helloappscrmfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.helloappscrmfsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.helloappscrmfsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.helloappscrmfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.helloappscrmfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.helloappscrmfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.helloappscrmfsm.features.viewPPDDStock.ViewStockFragment
import com.helloappscrmfsm.features.weather.presentation.WeatherFragment
import com.helloappscrmfsm.mappackage.MapActivity
import com.helloappscrmfsm.mappackage.MapActivityWithoutPath
import com.helloappscrmfsm.mappackage.SendBrod
import com.helloappscrmfsm.widgets.AppCustomEditText
import com.helloappscrmfsm.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xhelloappscrmfsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xhelloappscrmfsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.helloappscrmfsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xhelloappscrmfsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xhelloappscrmfsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xhelloappscrmfsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xhelloappscrmfsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
